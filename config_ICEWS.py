...
Configuration for ICEWS dataset.
"""
...
class cfg:
    """Configuration manager for RULE model on ICEWS dataset."""
    ...
    def get_args(self):
        parser = argparse.ArgumentParser(description='RULE for ICEWS Dataset')
        ...
        # ==================== Model Settings ====================
        parser.add_argument('--hidden_units', type=str, default='150,150,150',
        ...
        parser.add_argument('--attr_dim', type=int, default=150, help='Attribute embedding dimension')
        parser.add_argument('--img_dim', type=int, default=150, help='Image embedding dimension')
        parser.add_argument('--char_dim', type=int, default=150, help='Character embedding dimension')
        parser.add_argument("--clip_name_dim", type=int, default=768, help="the hidden size of name feature")
        ...
        # ==================== Data Settings ====================
        parser.add_argument('--data_choice', default='ICEWS', type=str, 
                           choices=['DBP15K', 'ICEWS'], help='Dataset choice')
        parser.add_argument('--data_split', default='icews_wiki', type=str,
                           choices=['icews_wiki', 'icews_yago'], help='Dataset split')
